...
import { StyledDebugCloseButton, StyledDebugContent, StyledDebugContentWrapper, StyledDebugPanel, StyledDebugPanelWrapper } from "./debugPanel.styles";
...
const DebugPanel: React.FC<IDebugPanel> = (props) => {
    ...
    const onEnter = useCallback(() => {
        if (isClient) {
            !!panelWrapperRef.current && setWrapperWidth(width(panelWrapperRef.current));
