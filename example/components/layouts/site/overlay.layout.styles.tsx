...
export const StyledOverlayLayout = styled.div<IStyledOverlayLayout>`
    ...
    left: 0;
    height: calc(100vh - ${p => p.theme.spacingProps.headerHeight} - env(safe-area-inset-top) - env(safe-area-inset-bottom));
    max-height: calc(100vh - ${p => p.theme.spacingProps.headerHeight});
    width: 100vw;
    margin-left: auto;
    margin-right: auto;
    grid: "f d d d d d d s" min-content
