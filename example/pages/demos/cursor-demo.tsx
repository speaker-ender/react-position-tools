...
const CursorDemo: NextPage = () => {
  ...
  const positionCallback = useCallback(
    (activePixels: IPos, activePercent: IPos) => {
      activePixels &&
  ...
  return (
    <StyledPage>
      ...
      <StyledPanel>
        ...
        <Paragraph>
          Move the cursor around the viewport to see the image background change
          colors
        </Paragraph>
        <Paragraph>
          The percentage values being used can be seen in the debug panel
        </Paragraph>
      </StyledPanel>
      ...
      <DebugPanel defaultOpen={true}>
        ...
        <Paragraph>{`x: ${
          activeCursorPosition && activeCursorPosition.percent.x
        }%`}</Paragraph>
        <Paragraph>{`y: ${
          activeCursorPosition && activeCursorPosition.percent.y
        }%`}</Paragraph>
        <Paragraph>{`x: ${
          activeCursorPosition && activeCursorPosition.pixels.x
        }px`}</Paragraph>
        <Paragraph>{`y: ${
