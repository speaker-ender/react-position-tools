...
const KitchenSink: NextPage = () => {
  ...
  return (
    <StyledPage>
      ...
      <StyledPanel>
        ...
        <Paragraph
          dangerouslySetInnerHTML={{
            __html:
              "I'M A MONSTER!! Popcorn shrimp… with club sauce. Oh, COME ON! This objectification of women has to stop. It's just Mom and whores. And with deep, deep concentration and, and great focus, he's often able to achieve an erect– Pound is tic-tac-toe right?",
          }}
        />
        <Paragraph
          dangerouslySetInnerHTML={{
            __html:
              "Did you know that more frozen bananas are sold right here on this boardwalk than anywhere in the OC? You're Killing Me, Buster. What is she doing at a beauty pageant? Is she running the lights or something? This was a big get for God. Although George Michael had only got to second base, he'd gone in head first, like Pete Rose. Yo quiero leche. Yo quiero leche de madre.",
          }}
        />
        <Paragraph
          dangerouslySetInnerHTML={{
            __html:
              "Yo quiero leche. Yo quiero leche de madre. Yo quiero leche. Yo quiero leche de madre. Caw ca caw, caw ca caw, caw ca caw, caw ca caw. Hey, it was one night of wild passion! Michael: And yet you didn't notice her body? Gob: I like to look in the mirror. And guess what else is back. [slow wink] My breakfast? My friskiness. Mama horny Michael. Oh Gob, you could charm the black off a telegram boy.",
          }}
        />
      ...
      <ParagraphComponent
        fullWidth={true}
        text="I'M A MONSTER!! Popcorn shrimp… with club sauce. Oh, COME ON! This objectification of women has to stop. It's just Mom and whores. And with deep, deep concentration and, and great focus, he's often able to achieve an erect– Pound is tic-tac-toe right?"
      />
      <StyledTwoColumns>
      ...
      <StyledButton
        onClick={() =>
          setAlert({
            title: "Alert",
            text: "Alertalert Alertalert Alertalert Alertalert Alertalertv Alertalert Alertalert Alertalert Alertalert",
            prompt: "close",
          })
        }
      >
      ...
      <StyledButton
        onClick={() =>
          setNotification({
            title: "Hello",
            text: "hello there, here is a notification",
          })
        }
      >
        Trigger Notification
      </StyledButton>
      <StyledButton onClick={() => setBannerActive(true)}>
        Bring back banner
      </StyledButton>
      <Drawer title="Drawer">
